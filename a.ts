...
const c = {
  descriptions: [
    ...
    {
      description: "Il aime se détendre",
      language: {
        name: "fr",
    ...
    {
      description: "Mag es, sich zu entspannen",
      language: {
        name: "de",
    ...
    {
      description: "Le gusta relajarse",
      language: {
        name: "es",
